...
export class MenusEffects {
    constructor(private router: Router, private location: Location, private actions$: Actions<any>, private apiService: ApiService) {}
        ...
        this.actions$.pipe(
            ...
            switchMap(() =>
                this.apiService.getItems().pipe(
                    map((menuItems) => MenusActions.fetchMenuSuccess({ menuItems: menuItems })),
                    catchError((error) => of(MenusActions.fetchMenuFailed({ error: error })))
                )
            )
        )
    );
        ...
        this.actions$.pipe(
            ...
            switchMap((action) =>
                this.apiService.addItem(action.menuItem).pipe(
                    ...
                    catchError((error) => of(MenusActions.addMenuItemFailed({ error: error })))
                )
            )
        )
    );
        ...
        this.actions$.pipe(
            ...
            switchMap((action) =>
                this.apiService.updateItem(action.menuItem).pipe(
                    ...
                    map(() => MenusActions.editMenuItemSuccess({ menuItem: action.menuItem })),
                    catchError((error) => of(MenusActions.editMenuItemFailed({ error: error })))
                )
            )
        )
    );
        ...
        this.actions$.pipe(
            ...
            switchMap((action) =>
                this.apiService.deleteItem(action.menuId).pipe(
                    tap(() => this.router.navigate(['/menu'])),
                    map(() => MenusActions.deleteMenuItemSuccess({ menuId: action.menuId })),
                    catchError((error) => of(MenusActions.deleteMenuItemFailed({ error: error })))
                )
            )
        )
    );
