...
const MenuItemPlaceholder: BaseMenuItem = {
    ...
    description: 'A plate of light and crispy French fries using Idaho potatoes and peanut oil',
    image: 'https://as2.ftcdn.net/jpg/02/13/18/09/500_F_213180964_DfqvRIHj0D3t9duYUROXuQ011AgVJIaM.jpg',
    calories: 410,
    category: 'sides',
};
...
export class AddItemComponent {
    ...
    constructor(private location: Location, private menusStateService: MenusStateService, private store: Store) {}
